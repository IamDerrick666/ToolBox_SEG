...
def main():
    ...
    for fold, (train_ids, val_ids) in enumerate(kf.split(dataset)):
        ...
        for epoch in range(NUM_EPOCHS):
            ...
            iou, dice, sensitivity, specificity, precision, auc, accuracy = val_fn(val_loader, model, device=DEVICE)
            epoch_data = [iou, dice, sensitivity, specificity, precision, auc, accuracy, train_loss, val_loss]
